...
elem.innerHTML = "";
elem.innerHTML += "<select><option>Empty</option></select> <button class='btn' id='save'>Save</button><button class='btn' id='load'>Load</button><button class='btn' id='download'>Download</button> | <button class='btn' id='webgl'>WebGL</button> <button class='btn' id='multiview'>Multiview</button>";
...
//some examples
addDemo("Features", "examples/down.json");
addDemo("Features", "examples/up.json");
addDemo("Features", "examples/d13=1.json");
addDemo("Features", "examples/set.json");
addDemo("Features", "examples/clear.json");
addDemo("Features", "examples/d13=0.json");
